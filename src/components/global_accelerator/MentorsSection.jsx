...
const MentorsSection = () => {
  return (
    <section className="investor-profiles-section bg-gradient-to-tl from-orange-700 via-orange-900 to-gray-900 text-white py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-0 sm:px-6 lg:px-8"> {/* Adjusted px for full-bleed potential */}
        <h2
          className="text-4xl md:text-5xl font-bold mb-12 md:mb-16 text-center text-white px-4" // Added px here for title centering
          style={{ textShadow: '0 2px 5px rgba(0,0,0,0.6)' }}
        >
          Meet the Mentors
        </h2>
        <div className="investor-carousel-wrapper w-full overflow-x-auto pb-8 -mx-0 sm:-mx-0"> {/* Adjusted margins */}
          <div className="flex space-x-6 lg:space-x-8 px-4 sm:px-6 py-2 min-w-max"> {/* Ensure parent can scroll if content wider */}
