...
const MentorCard = ({ imgSrc, name, title, bio }) => {
  return (
    <div className="bg-white flex flex-col rounded-xl shadow-xl hover:shadow-2xl overflow-hidden w-full max-w-[20rem] h-[39rem] flex-shrink-0 transition-all duration-300 ease-in-out transform hover:-translate-y-2 border border-gray-200 hover:border-orange-500">
