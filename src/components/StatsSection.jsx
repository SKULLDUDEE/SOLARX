...
export default function StatsSection() {
  ...
  return (
    <section id="stats" className="bg-white py-12 sm:py-16 md:py-20 relative min-h-[60vh]">
      {/* Background Blurs */}
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
            Transforming the solar energy landscape with innovative solutions across the globe
          </p>
          <div className="w-16 sm:w-24 h-1 bg-orange-500 mx-auto rounded-full mt-4 sm:mt-6"></div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
          {stats.map((stat) => (
            ...
            >
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-orange-600 mb-2 sm:mb-3">{stat.value}</h3>
