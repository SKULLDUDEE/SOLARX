        ...
        (mediaCoverage.length > 0 || awards.length > 0) && (
          <div>
            ...
            <div
              className={`${
                awards.length > 0
                  ? "grid md:grid-cols-2 gap-x-16 gap-y-6 mb-8"
                  : "mb-8"
              }`}
            >
              {awards.length > 0 && (
                ...
                <div className="animate-slide-in-left">
                  ...
                  >
                    {mediaCoverage.map((article, index) => (
                      <div
                        key={article.id}
                        className={`flex items-start space-x-4 group hover:bg-gradient-to-br hover:from-white hover:to-orange-50 hover:shadow-xl hover:scale-102 transition-all duration-300 ease-in-out p-6 rounded-xl cursor-pointer border border-transparent hover:border-orange-200 animation-delay-${
                          (index % 4) * 150
                        }`}
                      >
